...
function gameScene:onEnter()
	...
	self.mainRoleEntity:addToLayer(self.back,0)
	...
	elseif sceneConfig.sceneMonsterType == globalGameEnum.CONFIGREADER_SCENE_CANNOTSEE then
		local randomX = math.random(1,self.moveSize.width)
		local randomY = math.random(1,self.moveSize.height)
		...
		if getTableSize(sceneConfig.sceneOutPos) ~= 0 then
			...
			self.back:addChild(self.outPointEffect)
		end
	end
